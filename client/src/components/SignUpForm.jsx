            ...
            <div className="w-full bg-zinc-800 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div className="p-6">
                    ...
                    <form className="space-y-4 md:space-y-6 mt-4" onSubmit={(e) => handleSubmit(e)}>
                        ...
                        <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.9 }} type="submit" className="w-full text-white bg-peach hover:bg-peach-dark focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create Account</motion.button>
