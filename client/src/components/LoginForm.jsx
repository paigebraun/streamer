        ...
        <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            ...
            <div className="w-full bg-zinc-800 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0">
                <div className="p-6">
                    ...
                    {error && (
                        <p className="text-peach mt-4">
                        {error}
                        </p>
                    )}
                    <form className="space-y-4 md:space-y-6 mt-4" onSubmit={(e) => handleSubmit(e)}>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="password" name="password" value={state.password || ''} id="password" onChange={(e) => handleChange(e)} placeholder="••••••••" autoComplete="on" className="bg-zinc-600 text-white sm:text-sm rounded-lg focus:ring-peach focus:border-peach block w-full p-2.5" required=""></input>
                        </div>
                        <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.9 }} type="submit" className="w-full text-white bg-peach hover:bg-peach-dark focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center">Sign In</motion.button>
