                ...
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <div className="relative">
                        <div
                            ...
                            className="cursor-pointer bg-zinc-800 p-2 text-white flex items-center justify-between rounded min-w-40 relative">
                            {selected}
                            <FaChevronDown
                                className={`${
                                    open && "rotate-180"
                        ...
                        <ul
                            className={`bg-zinc-800 mt-2 overflow-y-auto cursor-pointer ${
                                open ? "max-h-60" : "max-h-0"
                            } absolute z-10 rounded w-full`}>
                            <li
                                className="hover:bg-peach text-white rounded p-2"
                                onClick={() => {
                ...
                {loggedIn ? (
                    sortedWatchlist.length !== 0 ? (
                            ...
                            <div
                                className={`flex ${
                                    currentPage === "userProfile"
                                        ? "flex-wrap"
                                        : "flex-nowrap"
                                } items-start gap-4 justify-center`}>
                        ...
                        <p
                            ...
                            Add movies or series to your watchlist, and they
                            will show up here.
                        </p>
                    )
                ) : (
