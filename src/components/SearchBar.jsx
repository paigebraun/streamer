    ...
    return(
        <form className="w-1/2">   
            ...
            <div className="relative">
                ...
                <input type="search" id="default-search" className="w-full block w-full py-2.5 pl-16 text-gray-800 border rounded-full bg-gray-50 focus:outline-none focus:ring-peach focus:border-peach" placeholder="Look Up Movies, TV, Actors, Directors..." required></input>
